...
const { EditUser, GetStats, SendFriendRequest, RespondFriendRequest, GetFriends, GetUser, GetUsers, UnsendFriendRequest, RemoveFriend } = require('../middlewares/userControl');
